...
class PlayerToPlayerCreditTransaction extends CreditTransaction
{
	...
	{
		$status = ColorResource::getInfo($this->receiver->faction->identifier, 'status');
