							...
							if ($remainingShips >= $commercialShipQuantity) {
								switch ($type) {
									...
									case Transaction::TYP_SHIP :
										...
										break;
									case Transaction::TYP_COMMANDER :
										if (($commander = $commanderManager->get($identifier)) !== null AND $commander->getRPlayer() == $currentPlayer->getId() AND $commander->statement !== Commander::ONSALE) {
