...
class LawResources
{
	public const APPLICATION_MODE_INSTANTANEOUS = 'instantaneous';
	public const APPLICATION_MODE_CUSTOM_DURATION = 'custom_duration';
	...
	private static array $laws = [
		[
			...
			'image' => '',
			'isImplemented' => true,
			'application_mode' => self::APPLICATION_MODE_INSTANTANEOUS,
		],
		[
			'id' => 2,
			'bonusLaw' => false,
		...
		[
			...
			'image' => '',
			'isImplemented' => true,
			'application_mode' => self::APPLICATION_MODE_CUSTOM_DURATION,
		],
		[
			'id' => 6,
			'bonusLaw' => true,
