...
class UnitOfWork
{
	...
	public const METADATA_STAGED = 'staged';
	// Entity is persisted in database
	public const METADATA_PERSISTED = 'persisted';
	// Entity is persisted in database and will be removed
	public const METADATA_REMOVED = 'removed';
	...
	{
		$identifier = (null !== $object->getId()) ? (int) $object->getId() : spl_object_hash($object);
	...
	{
		$identifier = (null !== $object->getId()) ? $object->getId() : spl_object_hash($object);
